...
/**
 *
 * https://github.com/akka/alpakka/tree/master/sse/src
 * Reason for include of the source is and not by library is that EventStreamUnmarshalling must be overriden
 * due to max event/line size (should be greater than 8/4k).
 *
...
object EventSource {
  ...
  def apply(
    ...
    import EventStreamUnmarshallingExt._
