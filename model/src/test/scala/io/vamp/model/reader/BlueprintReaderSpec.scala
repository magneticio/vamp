...
class BlueprintReaderSpec extends FlatSpec with Matchers with ReaderSpec {
  ...
  "BlueprintReader" should "read the simplest YAML (name and single breed only)" in {
    BlueprintReader.read(res("blueprint/blueprint1.yml")) should have(
      ...
      'clusters(List(Cluster("notorious", Map(), List(Service(BreedReference("nocturnal-viper"), Nil, None, Nil, Nil)), Nil, None))),
      'gateways(Nil),
  ...
  it should "read the reference sla" in {
    BlueprintReader.read(res("blueprint/blueprint3.yml")) should have(
      'name("nomadic-frostbite"),
      'clusters(List(Cluster("notorious", Map(), List(Service(BreedReference("nocturnal-viper"), Nil, None, Nil, Nil)), Nil, None, Some(SlaReference("strong-mountain", Nil))))),
      'gateways(Nil),
      'environmentVariables(Nil)
    )
  }
  ...
  it should "read the reference sla with escalations" in {
    BlueprintReader.read(res("blueprint/blueprint5.yml")) should have(
      'name("nomadic-frostbite"),
      'clusters(List(Cluster("notorious", Map(), List(Service(BreedReference("nocturnal-viper"), Nil, None, Nil, Nil)), Nil, None, Some(SlaReference("strong-mountain", List(ToAllEscalation("", Map(), List(EscalationReference("red-flag"), EscalationReference("hideous-screaming"), GenericEscalation("", Map(), "cloud-beam", Map("sound" → "furious")))))))))),
      'gateways(Nil),
      'environmentVariables(Nil)
    )
  }
  ...
  it should "read the anonymous sla" in {
    BlueprintReader.read(res("blueprint/blueprint6.yml")) should have(
      'name("nomadic-frostbite"),
      'clusters(List(Cluster("notorious", Map(), List(Service(BreedReference("nocturnal-viper"), Nil, None, Nil, Nil)), Nil, None, Some(GenericSla("", Map(), "vital-cloud", Nil, Map("reborn" → "red-swallow")))))),
      'gateways(Nil),
      'environmentVariables(Nil)
    )
  }
  ...
  it should "read the anonymous sla with escalations" in {
    BlueprintReader.read(res("blueprint/blueprint7.yml")) should have(
      'name("nomadic-frostbite"),
      'clusters(List(Cluster("notorious", Map(), List(Service(BreedReference("nocturnal-viper"), Nil, None, Nil, Nil)), Nil, None, Some(GenericSla("", Map(), "vital-cloud", List(EscalationReference("red-flag")), Map("reborn" → "red-swallow")))))),
      'gateways(Nil),
      'environmentVariables(Nil)
    )
  }
  ...
  it should "read the anonymous scale" in {
    BlueprintReader.read(res("blueprint/blueprint8.yml")) should have(
      'name("nomadic-frostbite"),
      'clusters(List(Cluster("notorious", Map(), List(Service(BreedReference("nocturnal-viper"), Nil, Some(DefaultScale("", Map(), Quantity(0.2), MegaByte(120), 2)), Nil, Nil)), Nil, None))),
      'gateways(Nil),
      'environmentVariables(Nil)
    )
  }
  ...
  it should "read the reference scale" in {
    BlueprintReader.read(res("blueprint/blueprint9.yml")) should have(
      'name("nomadic-frostbite"),
      'clusters(List(Cluster("notorious", Map(), List(Service(BreedReference("nocturnal-viper"), Nil, Some(ScaleReference("large")), Nil, Nil)), Nil, None))),
      'gateways(Nil),
      'environmentVariables(Nil)
    )
  }
  ...
  it should "read the reference route" in {
    BlueprintReader.read(res("blueprint/blueprint11.yml")) should have(
      'name("nomadic-frostbite"),
      'clusters(List(Cluster("notorious", Map(), List(Service(BreedReference("nocturnal-viper"), Nil, None, Nil, Nil)), List(Gateway("", Map(), Port("", None, None), None, None, Nil, List(RouteReference("conservative", "nocturnal-viper")))), None))),
      'gateways(Nil),
      'environmentVariables(Nil)
    )
  }
  ...
  it should "read the route with weight" in {
    BlueprintReader.read(res("blueprint/blueprint12.yml")) should have(
      'name("nomadic-frostbite"),
      'clusters(List(Cluster("notorious", Map(), List(Service(BreedReference("nocturnal-viper"), Nil, None, Nil, Nil)), List(Gateway("", Map(), Port("", None, None), None, None, Nil, List(DefaultRoute("", Map(), "nocturnal-viper", Some(Percentage(100)), None, None, Nil, None)))), None, None, Map()))),
      'gateways(Nil),
      'environmentVariables(Nil)
    )
  }
  ...
  it should "read the route with filter reference" in {
    BlueprintReader.read(res("blueprint/blueprint13.yml")) should have(
      'name("nomadic-frostbite"),
      'clusters(List(Cluster("notorious", Map(), List(Service(BreedReference("nocturnal-viper"), Nil, None, Nil, Nil)), List(Gateway("", Map(), Port("", None, None), None, None, Nil, List(DefaultRoute("", Map(), "nocturnal-viper", None, Option(DefaultCondition("", Map(), "android")), None, Nil, None)))), None))),
      'gateways(Nil),
      'environmentVariables(Nil)
    )
  }
  ...
  it should "read the route with filter references" in {
    BlueprintReader.read(res("blueprint/blueprint14.yml")) should have(
      'name("nomadic-frostbite"),
      'clusters(List(Cluster("notorious", Map(), List(Service(BreedReference("nocturnal-viper"), Nil, None, Nil, Nil)), List(Gateway("", Map(), Port("", None, None), None, None, Nil, List(DefaultRoute("", Map(), "nocturnal-viper", None, Option(ConditionReference("ios")), None, Nil, None)))), None))),
      'gateways(Nil),
      'environmentVariables(Nil)
    )
  }
  ...
  it should "read the route with anonymous filter" in {
    BlueprintReader.read(res("blueprint/blueprint15.yml")) should have(
      'name("nomadic-frostbite"),
      'clusters(List(Cluster("notorious", Map(), List(Service(BreedReference("nocturnal-viper"), Nil, None, Nil, Nil)), List(Gateway("", Map(), Port("", None, None), None, None, Nil, List(DefaultRoute("", Map(), "nocturnal-viper", Some(Percentage(100)), Option(DefaultCondition("", Map(), "user.agent != ios")), None, Nil, None)))), None))),
      'gateways(Nil),
      'environmentVariables(Nil)
    )
  }
  ...
  it should "expand the more complex blueprint" in {
    BlueprintReader.read(res("blueprint/blueprint21.yml")) should have(
      'name("nomadic-frostbite"),
      'clusters(List(Cluster("supersonic", Map(), List(Service(BreedReference("solid-barbershop"), Nil, Some(DefaultScale("", Map(), Quantity(0.2), MegaByte(120), 2)), Nil, Nil), Service(BreedReference("remote-venus"), Nil, Some(ScaleReference("worthy")), Nil, Nil)), List(Gateway("", Map(), Port("", None, None), None, None, Nil, List(DefaultRoute("", Map(), "solid-barbershop", Some(Percentage(100)), Option(DefaultCondition("", Map(), "ua = android")), None, Nil, None)))), None, Some(GenericSla("", Map(), "vital-cloud", List(ToAllEscalation("", Map(), List(EscalationReference("red-flag"), EscalationReference("hideous-screaming"), GenericEscalation("", Map(), "cloud-beam", Map("sound" → "furious"))))), Map("reborn" → "red-swallow")))), Cluster("notorious", Map(), List(Service(DefaultBreed("nocturnal-viper", Map(), Deployable("anaconda"), Nil, Nil, Nil, Nil, Map()), Nil, None, Nil, Nil)), Nil, None), Cluster("needless", Map(), List(Service(DefaultBreed("hideous-canal", Map(), Deployable("old/crystal"), Nil, Nil, Nil, Nil, Map()), Nil, None, Nil, Nil)), Nil, None, Some(SlaReference("fish-steamy", Nil))), Cluster("omega", Map(), List(Service(BreedReference("scary-lion"), Nil, None, Nil, Nil)), Nil, None))),
  ...
  it should "validate gateways for inline breeds - valid case" in {
    BlueprintReader.read(res("blueprint/blueprint22.yml")) should have(
      'name("nomadic-frostbite"),
      'clusters(List(Cluster("supersonic", Map(), List(Service(DefaultBreed("solid-barbershop", Map(), Deployable("vamp/solid-barbershop"), List(Port("port", None, Some("80/http"))), Nil, Nil, Nil, Map()), Nil, None, Nil, Nil)), Nil, None))),
      'gateways(List(Gateway("", Map(), Port("8080", None, Some("8080")), None, None, Nil, List(DefaultRoute("", Map(), "supersonic/port", None, None, None, Nil, None))))),
      'environmentVariables(Nil)
    )
  }
  ...
  it should "validate environment variables for inline breeds - valid case" in {
    BlueprintReader.read(res("blueprint/blueprint26.yml")) should have(
      'name("nomadic-frostbite"),
      'clusters(List(Cluster("supersonic", Map(), List(Service(DefaultBreed("solid-barbershop", Map(), Deployable("vamp/solid-barbershop"), Nil, List(EnvironmentVariable("port", None, None)), Nil, Nil, Map()), Nil, None, Nil, Nil)), Nil, None))),
      'gateways(Nil),
  ...
  it should "validate breed cross dependencies - inline and valid" in {
    BlueprintReader.read(res("blueprint/blueprint34.yml")) should have(
      'name("nomadic-frostbite"),
      'clusters(List(Cluster("supersonic", Map(), List(Service(DefaultBreed("solid-barbershop", Map(), Deployable("solid/barbershop"), Nil, Nil, Nil, Nil, Map("es" → BreedReference("elastic-search"))), Nil, None, Nil, Nil)), Nil, None), Cluster("notorious", Map(), List(Service(BreedReference("elastic-search"), Nil, None, Nil, Nil)), Nil, None))),
      'gateways(Nil),
      'environmentVariables(Nil)
    )
  }
  ...
  it should "expand the service with breed only object" in {
    BlueprintReader.read(res("blueprint/blueprint36.yml")) should have(
      'name("nomadic-frostbite"),
      'clusters(List(Cluster("supersonic", Map(), List(Service(DefaultBreed("solid-barbershop", Map(), Deployable("donut"), Nil, Nil, Nil, Nil, Map()), Nil, None, Nil, Nil)), Nil, None))),
      'gateways(Nil),
      'environmentVariables(Nil)
    )
  }
  ...
  it should "expand the service with breed reference only object" in {
    BlueprintReader.read(res("blueprint/blueprint37.yml")) should have(
      'name("nomadic-frostbite"),
      'clusters(List(Cluster("supersonic", Map(), List(Service(BreedReference("solid-barbershop"), Nil, None, Nil, Nil)), Nil, None))),
      'gateways(Nil),
      'environmentVariables(Nil)
    )
  }
  ...
  it should "read scale and route - expanded" in {
    BlueprintReader.read(res("blueprint/blueprint38.yml")) should have(
      'name("nomadic-frostbite"),
      'clusters(List(Cluster("supersonic", Map(), List(Service(DefaultBreed("sava1", Map(), Deployable("magneticio/sava:latest"), List(Port("port", None, Some("80/http"))), Nil, Nil, Nil, Map()), Nil, Some(DefaultScale("", Map(), Quantity(0.5), MegaByte(512), 1)), Nil, Nil)), List(Gateway("", Map(), Port("port", None, None), None, None, Nil, List(DefaultRoute("", Map(), "sava1", None, Option(DefaultCondition("", Map(), "android")), None, Nil, None)))), None))),
      'gateways(List(Gateway("", Map(), Port("8080", None, Some("8080")), None, None, Nil, List(DefaultRoute("", Map(), "supersonic/port", None, None, None, Nil, None))))),
      'environmentVariables(Nil)
    )
  }
  ...
  it should "read scale and route - no service and compact breed." in {
    BlueprintReader.read(res("blueprint/blueprint41.yml")) should have(
      'name("nomadic-frostbite"),
      'clusters(List(Cluster("supersonic", Map(), List(Service(BreedReference("sava1"), Nil, Some(ScaleReference("large")), Nil, Nil)), List(Gateway("", Map(), Port("", None, None), None, None, Nil, List(DefaultRoute("", Map(), "sava1", None, Option(DefaultCondition("", Map(), "android")), None, Nil, None)))), None))),
      'gateways(List(Gateway("", Map(), Port("8080", None, Some("8080")), None, None, Nil, List(DefaultRoute("", Map(), "supersonic/port", None, None, None, Nil, None))))),
      'environmentVariables(Nil)
    )
  }
  ...
  it should "read scale and route - cluster contains list." in {
    BlueprintReader.read(res("blueprint/blueprint42.yml")) should have(
      'name("nomadic-frostbite"),
      'clusters(List(Cluster("supersonic", Map(), List(Service(BreedReference("sava1"), Nil, Some(ScaleReference("large")), Nil, Nil)), Nil, None))),
      'gateways(List(Gateway("", Map(), Port("8080", None, Some("8080")), None, None, Nil, List(DefaultRoute("", Map(), "supersonic/port", None, None, None, Nil, None))))),
      'environmentVariables(Nil)
    )
  }
  ...
  it should "expand single reference filter to a list" in {
    BlueprintReader.read(res("blueprint/blueprint45.yml")) should have(
      'name("nomadic-frostbite"),
      'clusters(List(Cluster("supersonic", Map(), List(Service(BreedReference("sava1"), Nil, None, Nil, Nil)), List(Gateway("", Map(), Port("", None, None), None, None, Nil, List(DefaultRoute("", Map(), "sava1", None, Option(DefaultCondition("", Map(), "android")), None, Nil, None)))), None))),
      'gateways(List(Gateway("", Map(), Port("8080", None, Some("8080")), None, None, Nil, List(DefaultRoute("", Map(), "supersonic/port", None, None, None, Nil, None))))),
      'environmentVariables(Nil)
    )
  }
  ...
  it should "expand single filter to a list" in {
    BlueprintReader.read(res("blueprint/blueprint46.yml")) should have(
      'name("nomadic-frostbite"),
      'clusters(List(Cluster("supersonic", Map(), List(Service(BreedReference("sava1"), Nil, Some(ScaleReference("large")), Nil, Nil)), List(Gateway("", Map(), Port("", None, None), None, None, Nil, List(DefaultRoute("", Map(), "sava1", None, Option(DefaultCondition("", Map(), "user.agent == android")), None, Nil, None)))), None))),
      'gateways(List(Gateway("", Map(), Port("8080", None, Some("8080")), None, None, Nil, List(DefaultRoute("", Map(), "supersonic/port", None, None, None, Nil, None))))),
      'environmentVariables(Nil)
    )
  }
  ...
  it should "read service environment variables" in {
    BlueprintReader.read(res("blueprint/blueprint50.yml")) should have(
      'name("nomadic-frostbite"),
      'clusters(List(Cluster("supersonic", Map(), List(Service(DefaultBreed("solid-barbershop", Map(), Deployable("vamp/solid-barbershop"), Nil, List(EnvironmentVariable("HEAP", None, Some("1024MB"))), Nil, Nil, Map()), List(EnvironmentVariable("HEAP", None, Some("2GB"), None)), None, Nil, Nil, None, Map())), Nil, None, None, Map()))),
      'environmentVariables(Nil)
    )
  }
  ...
  it should "read service environment variables for ref breed" in {
    BlueprintReader.read(res("blueprint/blueprint51.yml")) should have(
      'name("nomadic-frostbite"),
      'clusters(List(Cluster("supersonic", Map(), List(Service(BreedReference("solid-barbershop"), List(EnvironmentVariable("HEAP", None, Some("2GB"), None)), None, Nil, Nil, None, Map())), Nil, None, None, Map()))),
      'environmentVariables(Nil)
    )
  }
  ...
  it should "read sticky route" in {
    BlueprintReader.read(res("blueprint/blueprint57.yml")) should have(
      'name("nomadic-frostbite"),
      'clusters(List(Cluster("notorious", Map(), List(Service(BreedReference("nocturnal-viper"), Nil, None, Nil, Nil, None, Map())), List(Gateway("", Map(), Port("", None, None), None, Some(Gateway.Sticky.Route), Nil, Nil)), None, None, Map()))),
      'environmentVariables(Nil)
    )
  }
  ...
  it should "read sticky instance" in {
    BlueprintReader.read(res("blueprint/blueprint58.yml")) should have(
      'name("nomadic-frostbite"),
      'clusters(List(Cluster("notorious", Map(), List(Service(BreedReference("nocturnal-viper"), Nil, None, Nil, Nil, None, Map())), List(Gateway("", Map(), Port("", None, None), None, Some(Gateway.Sticky.Instance), Nil, Nil)), None, None, Map()))),
      'environmentVariables(Nil)
    )
  }
  ...
  it should "read sticky null" in {
    BlueprintReader.read(res("blueprint/blueprint63.yml")) should have(
      'name("nomadic-frostbite"),
      'clusters(List(Cluster("notorious", Map(), List(Service(BreedReference("nocturnal-viper"), Nil, None, Nil, Nil, None, Map())), List(Gateway("", Map(), Port("", None, None), None, None, Nil, Nil)), None, None, Map()))),
      'environmentVariables(Nil)
    )
  }
  ...
  it should "read complex gateway with weights" in {
    BlueprintReader.read(res("blueprint/blueprint72.yml")) should have(
      ...
      'clusters(List(Cluster("notorious", Map(), List(Service(BreedReference("nocturnal-viper"), Nil, None, Nil, Nil, None, Map())), Nil, None, None, Map())))
    )
  }
  ...
  it should "parse service arguments" in {
    BlueprintReader.read(res("blueprint/blueprint79.yml")) should have(
      'name("nomadic-frostbite"),
      'clusters(List(Cluster("notorious", Map(), List(Service(BreedReference("nocturnal-viper"), Nil, None, List(Argument("arg", "test"), Argument("privileged", "false")), Nil, None, Map())), Nil, None, None, Map())))
    )
  }
  ...
  it should "expand service arguments" in {
    BlueprintReader.read(res("blueprint/blueprint80.yml")) should have(
      'name("nomadic-frostbite"),
      'clusters(List(Cluster("notorious", Map(), List(Service(BreedReference("nocturnal-viper"), Nil, None, List(Argument("arg1", "test1"), Argument("arg2", "test2")), Nil, None, Map())), Nil, None, None, Map())))
    )
  }
  ...
  it should "read virtual hosts" in {
    BlueprintReader.read(res("blueprint/blueprint82.yml")) should have(
      ...
      'clusters(List(Cluster("notorious", Map(), List(Service(BreedReference("nocturnal-viper"), Nil, None, Nil, Nil, None, Map())), List(Gateway("", Map(), Port("web", None, None, 0, Port.Type.Http), None, None, List("route"), Nil)), None, None, Map())))
    )
  }
  ...
  it should "parse an empty condition as no condition" in {
    BlueprintReader.read(res("blueprint/blueprint83.yml")) should have(
      'name("nomadic-frostbite"),
      'clusters(List(Cluster("supersonic", Map(), List(Service(BreedReference("sava"), Nil, None, Nil, Nil)), List(Gateway("", Map(), Port("", None, None), None, None, Nil, List(DefaultRoute("", Map(), "sava", None, None, None, Nil, None)))), None)))
    )
  }
  ...
  it should "read service with network set" in {
    BlueprintReader.read(res("blueprint/blueprint87.yml")) should have(
      'name("nomadic-frostbite"),
      'clusters(List(Cluster("notorious", Map(), List(Service(BreedReference("nocturnal-viper"), Nil, None, Nil, Nil, Some("default"))), Nil, None))),
      'gateways(Nil),
      'environmentVariables(Nil)
    )
  }
  ...
  it should "read cluster with network set" in {
    BlueprintReader.read(res("blueprint/blueprint88.yml")) should have(
      'name("nomadic-frostbite"),
      'clusters(List(Cluster("notorious", Map(), List(Service(BreedReference("nocturnal-viper"), Nil, None, Nil, Nil, None)), Nil, Some("big"), None))),
      'gateways(Nil),
      'environmentVariables(Nil)
    )
  }
  ...
  it should "read cluster and service with network set" in {
    BlueprintReader.read(res("blueprint/blueprint89.yml")) should have(
      'name("nomadic-frostbite"),
      'clusters(List(Cluster("notorious", Map(), List(Service(BreedReference("nocturnal-viper"), Nil, None, Nil, Nil, Some("fox"))), Nil, Some("wolf"), None))),
      'gateways(Nil),
      'environmentVariables(Nil)
    )
  }
  ...
  it should "read metadata" in {
    BlueprintReader.read(res("blueprint/blueprint90.yml")) should have(
      ...
      'clusters(List(Cluster("notorious", Map(), List(Service(BreedReference("nocturnal-viper"), Nil, None, Nil, Nil, None)), Nil, None, None))),
