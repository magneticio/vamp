...
class BlueprintReaderSpec extends FlatSpec with Matchers with ReaderSpec {
  ...
  it should "read the gateways and parameters" in {
    BlueprintReader.read(res("blueprint/blueprint2.yml")) should have(
      'name("nomadic-frostbite"),
      'clusters(List(Cluster("notorious", Map(), List(Service(BreedReference("nocturnal-viper"), Nil, None, Nil, None)), Nil, None, None))),
      'gateways(List(Gateway("", Map(), Port("8080", None, Some("8080")), None, None, Nil, None, List(DefaultRoute("", Map(), "notorious/port", None, None, None, None, Nil, None))))),
  ...
  */
  ...
  it should "read the reference route" in {
    BlueprintReader.read(res("blueprint/blueprint11.yml")) should have(
      'name("nomadic-frostbite"),
      'clusters(List(Cluster("notorious", Map(), List(Service(BreedReference("nocturnal-viper"), Nil, None, Nil, None)), List(Gateway("", Map(), Port("", None, None), None, None, Nil, None, List(RouteReference("conservative", "nocturnal-viper")))), None, None))),
      'gateways(Nil),
      'environmentVariables(Nil)
    )
  }
  ...
  it should "read the route with weight" in {
    BlueprintReader.read(res("blueprint/blueprint12.yml")) should have(
      'name("nomadic-frostbite"),
      'clusters(List(Cluster("notorious", Map(), List(Service(BreedReference("nocturnal-viper"), Nil, None, Nil, None)), List(Gateway("", Map(), Port("", None, None), None, None, Nil, None, List(DefaultRoute("", Map(), "nocturnal-viper", None, Some(Percentage(100)), None, None, Nil, None)))), None, None, None, Map()))),
      'gateways(Nil),
      'environmentVariables(Nil)
    )
  }
  ...
  it should "read the route with filter reference" in {
    BlueprintReader.read(res("blueprint/blueprint13.yml")) should have(
      'name("nomadic-frostbite"),
      'clusters(List(Cluster("notorious", Map(), List(Service(BreedReference("nocturnal-viper"), Nil, None, Nil, None)), List(Gateway("", Map(), Port("", None, None), None, None, Nil, None, List(DefaultRoute("", Map(), "nocturnal-viper", None, None, Option(DefaultCondition("", Map(), "android")), None, Nil, None)))), None, None))),
      'gateways(Nil),
      'environmentVariables(Nil)
    )
  }
  ...
  it should "read the route with filter references" in {
    BlueprintReader.read(res("blueprint/blueprint14.yml")) should have(
      'name("nomadic-frostbite"),
      'clusters(List(Cluster("notorious", Map(), List(Service(BreedReference("nocturnal-viper"), Nil, None, Nil, None)), List(Gateway("", Map(), Port("", None, None), None, None, Nil, None, List(DefaultRoute("", Map(), "nocturnal-viper", None, None, Option(ConditionReference("ios")), None, Nil, None)))), None, None))),
      'gateways(Nil),
      'environmentVariables(Nil)
    )
  }
  ...
  it should "read the route with anonymous filter" in {
    BlueprintReader.read(res("blueprint/blueprint15.yml")) should have(
      'name("nomadic-frostbite"),
      'clusters(List(Cluster("notorious", Map(), List(Service(BreedReference("nocturnal-viper"), Nil, None, Nil, None)), List(Gateway("", Map(), Port("", None, None), None, None, Nil, None, List(DefaultRoute("", Map(), "nocturnal-viper", None, Some(Percentage(100)), Option(DefaultCondition("", Map(), "user.agent != ios")), None, Nil, None)))), None, None))),
      'gateways(Nil),
      'environmentVariables(Nil)
    )
  }
  ...
  */
  ...
  it should "read scale and route - no service and compact breed." in {
    BlueprintReader.read(res("blueprint/blueprint41.yml")) should have(
      'name("nomadic-frostbite"),
      'clusters(List(Cluster("supersonic", Map(), List(Service(BreedReference("sava1"), Nil, Some(ScaleReference("large")), Nil, None)), List(Gateway("", Map(), Port("", None, None), None, None, Nil, None, List(DefaultRoute("", Map(), "sava1", None, None, Option(DefaultCondition("", Map(), "android")), None, Nil, None)))), None, None))),
      'gateways(List(Gateway("", Map(), Port("8080", None, Some("8080")), None, None, Nil, None, List(DefaultRoute("", Map(), "supersonic/port", None, None, None, None, Nil, None))))),
      'environmentVariables(Nil)
    )
  }
  ...
  it should "expand single reference filter to a list" in {
    BlueprintReader.read(res("blueprint/blueprint45.yml")) should have(
      'name("nomadic-frostbite"),
      'clusters(List(Cluster("supersonic", Map(), List(Service(BreedReference("sava1"), Nil, None, Nil, None)), List(Gateway("", Map(), Port("", None, None), None, None, Nil, None, List(DefaultRoute("", Map(), "sava1", None, None, Option(DefaultCondition("", Map(), "android")), None, Nil, None)))), None, None))),
      'gateways(List(Gateway("", Map(), Port("8080", None, Some("8080")), None, None, Nil, None, List(DefaultRoute("", Map(), "supersonic/port", None, None, None, None, Nil, None))))),
      'environmentVariables(Nil)
    )
  }
  ...
  it should "expand single filter to a list" in {
    BlueprintReader.read(res("blueprint/blueprint46.yml")) should have(
      'name("nomadic-frostbite"),
      'clusters(List(Cluster("supersonic", Map(), List(Service(BreedReference("sava1"), Nil, Some(ScaleReference("large")), Nil, None)), List(Gateway("", Map(), Port("", None, None), None, None, Nil, None, List(DefaultRoute("", Map(), "sava1", None, None, Option(DefaultCondition("", Map(), "user.agent == android")), None, Nil, None)))), None, None))),
      'gateways(List(Gateway("", Map(), Port("8080", None, Some("8080")), None, None, Nil, None, List(DefaultRoute("", Map(), "supersonic/port", None, None, None, None, Nil, None))))),
      'environmentVariables(Nil)
    )
  }
  ...
  it should "process default port type" in {
    ...
    blueprint should have(
      'name("nomadic-frostbite"),
      'gateways(List(Gateway("", Map(), Port("8081", None, Some("8081")), None, None, Nil, None, List(DefaultRoute("", Map(), "supersonic/port", None, None, None, None, Nil, None))), Gateway("", Map(), Port("8082", None, Some("8082/tcp")), None, None, Nil, None, List(DefaultRoute("", Map(), "supersonic/health", None, None, None, None, Nil, None))), Gateway("", Map(), Port("8083", None, Some("8083/http")), None, None, Nil, None, List(DefaultRoute("", Map(), "supersonic/metrics", None, None, None, None, Nil, None))))),
      'clusters(List(Cluster("supersonic", Map(), List(Service(DefaultBreed("solid-barbershop", Map(), Deployable(None, "vamp/solid-barbershop"), List(Port("port", None, Some("80/http")), Port("health", None, Some("8080")), Port("metrics", None, Some("8090/tcp"))), Nil, Nil, Nil, Map(), None), Nil, None, Nil, None, None, Map())), Nil, None, None, None, Map())))
    )
  ...
  it should "read sticky route" in {
    BlueprintReader.read(res("blueprint/blueprint57.yml")) should have(
      'name("nomadic-frostbite"),
      'clusters(List(Cluster("notorious", Map(), List(Service(BreedReference("nocturnal-viper"), Nil, None, Nil, None, None, Map())), List(Gateway("", Map(), Port("", None, None), None, Some(Gateway.Sticky.Route), Nil, None, Nil)), None, None, None, Map()))),
      'environmentVariables(Nil)
    )
  }
  ...
  it should "read sticky instance" in {
    BlueprintReader.read(res("blueprint/blueprint58.yml")) should have(
      'name("nomadic-frostbite"),
      'clusters(List(Cluster("notorious", Map(), List(Service(BreedReference("nocturnal-viper"), Nil, None, Nil, None, None, Map())), List(Gateway("", Map(), Port("", None, None), None, Some(Gateway.Sticky.Instance), Nil, None, Nil)), None, None, None, Map()))),
      'environmentVariables(Nil)
    )
  }
  ...
  it should "parse multiple port routing" in {
    BlueprintReader.read(res("blueprint/blueprint61.yml")) should have(
      'name("nomadic-frostbite"),
      'clusters(List(Cluster("sava", Map(), List(Service(DefaultBreed("sava_1.0", Map(), Deployable(None, "magneticio/sava:1.0.0"), List(Port("web", None, Some("8080")), Port("admin", None, Some("8081"))), Nil, Nil, Nil, Map(), None), Nil, None, Nil, None, None, Map())), List(Gateway("", Map(), Port("web", None, None), None, Some(Gateway.Sticky.Route), Nil, None, Nil), Gateway("", Map(), Port("admin", None, None), None, Some(Gateway.Sticky.Instance), Nil, None, Nil)), None, None, None, Map()))),
      'gateways(Nil),
      'environmentVariables(Nil)
    )
  }
  ...
  it should "read sticky null" in {
    BlueprintReader.read(res("blueprint/blueprint63.yml")) should have(
      'name("nomadic-frostbite"),
      'clusters(List(Cluster("notorious", Map(), List(Service(BreedReference("nocturnal-viper"), Nil, None, Nil, None, None, Map())), List(Gateway("", Map(), Port("", None, None), None, None, Nil, None, Nil)), None, None, None, Map()))),
      'environmentVariables(Nil)
    )
  }
  ...
  it should "allow sticky http port" in {
    BlueprintReader.read(res("blueprint/blueprint64.yml")) should have(
      'name("nomadic-frostbite"),
      'clusters(List(Cluster("notorious", Map(), List(Service(DefaultBreed("nocturnal-viper", Map(), Deployable(None, "anaconda"), List(Port("web", None, Some("8080/http"))), Nil, Nil, Nil, Map(), None), Nil, None, Nil, None, None, Map())), List(Gateway("", Map(), Port("web", None, None), None, Some(Gateway.Sticky.Route), Nil, None, Nil)), None, None, None, Map()))),
      'environmentVariables(Nil)
    )
  }
  ...
  it should "not allow anonymous port mapping if more than 1 port defined" in {
    expectedError[IllegalAnonymousRoutingPortMappingError]({
      ...
      'breed(DefaultBreed("nocturnal-viper", Map(), Deployable(None, "anaconda"), List(Port("web", None, Some("8080")), Port("admin", None, Some("9090"))), Nil, Nil, Nil, Map(), None))
    )
  }
  ...
  it should "remap anonymous routing port" in {
    BlueprintReader.read(res("blueprint/blueprint68.yml")) should have(
      'name("nomadic-frostbite"),
      'clusters(List(Cluster("notorious", Map(), List(Service(DefaultBreed("nocturnal-viper", Map(), Deployable(None, "anaconda"), List(Port("web", None, Some("8080"))), Nil, Nil, Nil, Map(), None), Nil, None, Nil, None, None, Map())), List(Gateway("", Map(), Port("web", None, None), None, Some(Gateway.Sticky.Route), Nil, None, Nil)), None, None, None, Map()))),
      'environmentVariables(Nil)
    )
  }
  ...
  it should "read complex gateway" in {
    BlueprintReader.read(res("blueprint/blueprint69.yml")) should have(
      'name("nomadic-frostbite"),
      'clusters(List(Cluster("notorious", Map(), List(Service(DefaultBreed("nocturnal-viper", Map(), Deployable(None, "anaconda"), List(Port("web", None, Some("9050")), Port("admin", None, Some("9060"))), Nil, Nil, Nil, Map(), None), Nil, None, Nil, None, None, Map())), List(Gateway("", Map(), Port("web", None, None), None, Some(Gateway.Sticky.Route), Nil, None, Nil)), None, None, None, Map()))),
      'gateways(List(Gateway("", Map(), Port("8080", None, Some("8080")), None, None, Nil, None, List(DefaultRoute("", Map(), GatewayPath("notorious/web", List("notorious", "web")), None, None, None, None, Nil, None))), Gateway("", Map(), Port("8081", None, Some("8081")), None, Some(Gateway.Sticky.Route), Nil, None, List(DefaultRoute("", Map(), GatewayPath("notorious/admin", List("notorious", "admin")), None, None, None, None, Nil, None)))))
    )
  }
  ...
  it should "read complex gateway with weights" in {
    BlueprintReader.read(res("blueprint/blueprint72.yml")) should have(
      'name("nomadic-frostbite"),
      'gateways(List(Gateway("", Map(), Port("8080", None, Some("8080")), None, None, Nil, None, List(DefaultRoute("", Map(), GatewayPath("notorious/port1", List("notorious", "port1")), None, Some(Percentage(50)), None, None, Nil, None), DefaultRoute("", Map(), GatewayPath("notorious/port2", List("notorious", "port2")), None, Some(Percentage(50)), None, None, Nil, None), DefaultRoute("", Map(), GatewayPath("notorious/port3", List("notorious", "port3")), None, None, None, None, Nil, None))))),
  ...
  it should "fail on gateway weight > 100" in {
    expectedError[GatewayRouteWeightError]({
      ...
      'gateway(Gateway("", Map(), Port("8080", None, Some("8080")), None, None, Nil, None, List(DefaultRoute("", Map(), GatewayPath("notorious/port1", List("notorious", "port1")), None, Some(Percentage(50)), None, None, Nil, None), DefaultRoute("", Map(), GatewayPath("notorious/port2", List("notorious", "port2")), None, Some(Percentage(60)), None, None, Nil, None))))
    )
  }
  ...
  it should "read explicit gateway port" in {
    BlueprintReader.read(res("blueprint/blueprint76.yml")) should have(
      'name("nomadic-frostbite"),
      'clusters(List(Cluster("notorious", Map(), List(Service(BreedReference("nocturnal-viper"), Nil, None, Nil, None, None, Map())), Nil, None, None, None, Map()))),
      'gateways(List(Gateway("", Map(), Port("web", None, Some("8080/http")), None, None, Nil, None, List(DefaultRoute("", Map(), GatewayPath("notorious/web", List("notorious", "web")), None, None, None, None, Nil, None)))))
    )
  }
  ...
  it should "read virtual hosts" in {
    BlueprintReader.read(res("blueprint/blueprint82.yml")) should have(
      'name("nomadic-frostbite"),
      'gateways(List(Gateway("", Map(), Port("8080", None, Some("8080"), 8080, Port.Type.Http), None, None, List("test.com", "vamp"), None, List(DefaultRoute("", Map(), GatewayPath("notorious/port1", List("notorious", "port1")), None, Some(Percentage(100)), None, None, Nil, None, Nil))), Gateway("", Map(), Port("8081", None, Some("8081"), 8081, Port.Type.Http), None, None, List("test"), None, List(DefaultRoute("", Map(), GatewayPath("notorious/port1", List("notorious", "port1")), None, Some(Percentage(100)), None, None, Nil, None, Nil))))),
      'clusters(List(Cluster("notorious", Map(), List(Service(BreedReference("nocturnal-viper"), Nil, None, Nil, None, None, Map())), List(Gateway("", Map(), Port("web", None, None, 0, Port.Type.Http), None, None, List("route"), None, Nil)), None, None, None, Map())))
    )
  }
  ...
  it should "parse an empty condition as no condition" in {
    BlueprintReader.read(res("blueprint/blueprint83.yml")) should have(
      'name("nomadic-frostbite"),
      'clusters(List(Cluster("supersonic", Map(), List(Service(BreedReference("sava"), Nil, None, Nil, None)), List(Gateway("", Map(), Port("", None, None), None, None, Nil, None, List(DefaultRoute("", Map(), "sava", None, None, None, None, Nil, None)))), None, None)))
    )
  }
  ...
  it should "not fail on non existing port if any breed reference" in {
    BlueprintReader.read(res("blueprint/blueprint85.yml")) should have(
      'name("nomadic-frostbite"),
      'gateways(List(Gateway("", Map(), Port("8080", None, Some("8080"), 8080, Port.Type.Http), None, None, Nil, None, List(DefaultRoute("", Map(), GatewayPath("supersonic/http", List("supersonic", "http")), None, None, None, None, Nil, None, Nil))))),
      'clusters(List(Cluster("supersonic", Map(), List(Service(DefaultBreed("solid-barbershop", Map(), Deployable(None, "vamp/solid-barbershop"), List(Port("port", None, Some("80/http"), 80, Port.Type.Http)), Nil, Nil, Nil, Map(), None), Nil, None, Nil, None, None, Map()), Service(BreedReference("barbershop"), Nil, None, Nil, None, None, Map())), Nil, None, None, None, Map())))
    )
  }
  ...
  */
  ...
  it should "read metadata" in {
    BlueprintReader.read(res("blueprint/blueprint90.yml")) should have(
      ...
      'gateways(List(Gateway("", Map("labels" → Map("essential" → false)), Port("8080", None, Some("8080"), 8080, Port.Type.Http), None, None, Nil, None, List(DefaultRoute("", Map(), GatewayPath("notorious/web", List("notorious", "web")), None, None, None, None, Nil, None, Nil))))),
      'environmentVariables(Nil)
    )
  }
