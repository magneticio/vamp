...
object ComposeReader {
  ...
  def or[A](read: YamlSourceReader ⇒ ComposeReader[A])(readTwo: YamlSourceReader ⇒ ComposeReader[A])(implicit source: YamlSourceReader): ComposeReader[A] =
...
object ComposeBlueprintReader extends YamlReader[ComposeReader[Blueprint]] {
  ...
  private def flattenUnusedValues(implicit source: YamlSourceReader): ComposeReader[Unit] =
