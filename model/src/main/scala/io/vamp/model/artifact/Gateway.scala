...
case class Gateway(name: String, port: Port, sticky: Option[Gateway.Sticky.Value], virtualHosts: List[String], routes: List[Route], deployed: Boolean = false) extends Artifact with Lookup {
