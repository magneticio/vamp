...
case class Deployment(name: String, clusters: List[DeploymentCluster], endpoints: List[Port], environmentVariables: Map[Trait.Name, Any]) extends AbstractBlueprint
