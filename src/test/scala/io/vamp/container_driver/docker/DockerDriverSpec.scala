...
class DockerDriverSpec extends FlatSpec with Matchers with BeforeAndAfterAll with BeforeAndAfter {
  ...
  it should "return a list of running containers" in {
     ...
     val res = fixture.driver.deploy(deployment2, fixture.deploymentCluster, fixture.deploymentService, false)
     Await.result(res, 60 seconds).asInstanceOf[Any] 
  ...
  it should "kill available container" in {
     ...
     val res = fixture.driver.deploy(deployment3, fixture.deploymentCluster, fixture.deploymentService, false)
     Await.result(res, 60 seconds).asInstanceOf[Any]
