...
import io.vamp.persistence.slick.extension.{ AnonymousDeployable, Nameable, NamedDeployable }
import io.vamp.persistence.slick.model.ConstantParentType.ConstantParentType
import io.vamp.persistence.slick.model.DeploymentIntention.DeploymentIntentionType
import io.vamp.persistence.slick.model.DeploymentStep.DeploymentStepType
...
import io.vamp.persistence.slick.util.VampPersistenceUtil
