...
import io.vamp.model.artifact.{ Artifact, DefaultScale, Scale, ScaleReference }
import io.vamp.persistence.slick.model.{ DefaultScaleModel, DeploymentDefaultScale, ScaleReferenceModel }
