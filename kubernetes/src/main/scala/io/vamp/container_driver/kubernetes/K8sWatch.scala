...
class K8sWatch(client: K8sClient)(implicit system: ActorSystem) extends LazyLogging with Retriable with TimeUtil {
  ...
  val futureWatches = Seq(
    WatchDefinition(
      K8sCache.jobs,
      () ⇒ client.batchV1Api.listJobForAllNamespacesCall(null, null, false, null, null, null, null, timeout, true, null, null),
      (call: Call) ⇒ Watch.createWatch(client.batchV1Api.getApiClient, call, new TypeToken[Watch.Response[V1Job]]() {}.getType)
    ),

    WatchDefinition(
      K8sCache.pods,
      () ⇒ client.coreV1Api.listPodForAllNamespacesCall(null, null, false, null, null, null, null, timeout, true, null, null),
      (call: Call) ⇒ Watch.createWatch(client.coreV1Api.getApiClient, call, new TypeToken[Watch.Response[V1Pod]]() {}.getType)
    ),

    WatchDefinition(
      K8sCache.services,
      () ⇒ client.coreV1Api.listServiceForAllNamespacesCall(null, null, false, null, null, null, null, timeout, true, null, null),
      (call: Call) ⇒ Watch.createWatch(client.coreV1Api.getApiClient, call, new TypeToken[Watch.Response[V1Service]]() {}.getType)
    ),

    WatchDefinition(
      K8sCache.daemonSets,
      () ⇒ client.extensionsV1beta1Api.listDaemonSetForAllNamespacesCall(null, null, false, null, null, null, null, timeout, true, null, null),
    ...
    WatchDefinition(
      ...
      () ⇒ client.extensionsV1beta1Api.listDeploymentForAllNamespacesCall(null, null, false, null, null, null, null, timeout, true, null, null),
    ...
    WatchDefinition(
      ...
      () ⇒ client.extensionsV1beta1Api.listReplicaSetForAllNamespacesCall(null, null, false, null, null, null, null, timeout, true, null, null),
