...
import io.vamp.model.artifact.{ Artifact, DefaultFilter, Filter, FilterReference }
import io.vamp.persistence.notification.PersistenceNotificationProvider
import io.vamp.persistence.slick.model.{ DefaultRoutingModel, DeploymentDefaultFilter, DeploymentDefaultRouting, FilterReferenceModel }
