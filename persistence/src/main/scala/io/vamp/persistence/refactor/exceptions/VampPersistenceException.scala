...
case class InvalidFormatException[T](objectAsString: String, originalException: io.circe.Error)(implicit ns: Namespace, s: SerializationSpecifier[T]) extends
  Exception(s"Invalid persistence exception ${originalException.getMessage} for object of type ${s.typeName}. Cannot correctly interpret ${objectAsString}.")
