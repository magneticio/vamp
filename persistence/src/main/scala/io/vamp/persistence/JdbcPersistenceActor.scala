...
import io.vamp.persistence.jdbc._
import io.vamp.persistence.notification.{ ArtifactNotFound, PersistenceOperationFailure, UnsupportedPersistenceRequest }
import io.vamp.persistence.slick.components.Components
import io.vamp.persistence.slick.extension.Nameable
import io.vamp.persistence.slick.model.DeploymentGenericEscalation
...
trait JdbcPersistence
  ...
  val db: Database = Database.forConfig("vamp.persistence.jdbc.provider")
