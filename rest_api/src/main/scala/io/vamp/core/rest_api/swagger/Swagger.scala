...
case class Swagger(swagger: String, info: Info, host: String, basePath: String, tags: List[Any], schemes: List[String], paths: Paths, securityDefinitions: SecurityDefinitions, definitions: Definitions)