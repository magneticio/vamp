...
class DockerDriverSpec extends FlatSpec with Matchers with BeforeAndAfterAll with BeforeAndAfter {
  ...
  def fixture = new {
    ...
    val gateway = Gateway("e1d509c0-2e50-43e4-80dd-cd0d07a853a9/sava/port", Port("port", None, Some("0/http"), 0, Port.Type.Http), None, List(defaultRoute), deployed = false)
    ...
    val gateway1 = Gateway("e1d509c0-2e50-43e4-80dd-cd0d07a853a9/9050", Port("9050", None, Some("9050"), 9050, Port.Type.Http), None, List(defaultRoute1), deployed = false)
