...
case class Docker(image: String, portMappings: List[DockerPortMapping], parameters: List[DockerParameter] = List(DockerParameter("security-opt", "seccomp:unconfined")), network: String = "BRIDGE")
