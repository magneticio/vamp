...
trait DummyScales {
  ...
  private val defaultCpu = ConfigFactory.load().getDouble("vamp.core.dictionary.default-scale.cpu")
  private val defaultMemory = ConfigFactory.load().getDouble("vamp.core.dictionary.default-scale.memory")
  private val defaultInstances = ConfigFactory.load().getInt("vamp.core.dictionary.default-scale.instances")
