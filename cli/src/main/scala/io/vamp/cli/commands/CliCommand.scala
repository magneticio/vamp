...
trait CliCommand {
  ...
  val allArtifacts = List("blueprint", "breed", "deployment", "escalation", "condition", "rewrite", "gateway", "scale", "sla")
  val allArtifactsPlural = List("blueprints", "breeds", "deployments", "escalations", "conditions", "rewrites", "gateways", "scales", "slas")
}
